...
시리즈 라벨 (자연스러울 때만):
- short_version → "Korea in One Line:" 접두어 사용 가능
...
아래 스키마와 정확히 일치하는 JSON만 출력:
{
  ...
  "short_version": "핵심 주장 1개 + 근거 1개. 최대 2문장, 200자 이내.",
  "reply_drafts": [
    "맥락·데이터 추가 답글. 200자 이내. 대화체.",
    "통념 도전 답글. 200자 이내. 단정형 OK.",
    "관련 관찰 공유 답글. 200자 이내. 짧게."
  ],
  "quote_post_drafts": [
...
- "Korea in One Line:" 접두어 사용 가능 (자연스러울 때).

✅ 좋은 예:
- "Korea in One Line: 한은 금리 동결 5연속 — 시장은 이미 인하 베팅 시작했다"
- "반도체 수출 사상 최고인데 고용은 줄었다. 한국 제조업의 '고용 없는 호황'이 시작됐다"
...
- "핵심은 인하 여부보다 얼마나 오래 버티느냐다"
- "채권 시장 신호 먼저 보면 답이 나온다"
