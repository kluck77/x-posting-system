...
# ─── 출력 메타데이터 ─────────────────────────────────────────────────────────
#
# 출력 메타 관련 심볼은 app/services/output_meta.py 로 분리됨.
# 로직 변경 없음.
from app.services.output_meta import (  # noqa: F401  (re-export)
    ...
    _detect_reward_type,
    _validate_last_line_reward,
    _resolve_reward_type,
    _FINDABILITY_KNOWN_ENTITIES,
    _FINDABILITY_ANCHOR_RE,
    _ENTITY_ALIAS_MAP,
    _extract_first_two_sentences,
    _count_findability_anchors,
    _validate_findability,
    _MARKET_ANGLE_PATTERNS,
    _MARKET_ANGLE_VALID_TYPES,
    ...
    _VALID_OUTCOMES,
    MOD_REASON_ABSTRACT,
    MOD_REASON_NO_MARKET,
    MOD_REASON_UNRESOLVED,
    MOD_REASON_WEAK_HOOK,
    MOD_REASON_LOW_FIND,
    MOD_REASON_SUMMARY,
    MOD_REASON_OTHER,
    _VALID_MOD_REASONS,
...
from app.services.evidence_resolver import (  # noqa: F401  (re-export)
    _SOURCE_TEXT_MIN_LEN, _check_source_integrity,
...
# ─── question_resolver re-export ─────────────────────────────────────────
from app.services.question_resolver import (  # noqa: F401  (re-export)
    ReaderQuestion, _SOURCE_CITATION_RE, _SCOPE_NUMBER_RE,
