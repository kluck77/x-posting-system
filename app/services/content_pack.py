...
━━━ hook_candidates 규칙 (필수) ━━━

hook_candidates는 "소제목/방향표시"가 아니라 "X 첫 줄로 바로 써도 어색하지 않은 문장형"이다.

■ 금지: 명사형 제목, 화살표(→) 나열, 발표자료 제목
  ✗ "부동산 지옥 예고 → 서울시 경제 전반에 미치는 영향"
  ✗ "정원오 후보의 부동산 정책 → 서울시민의 미래 주택 문제"
  ✗ "호르무즈 리스크 → 한국 에너지 수입 비용 경로"

■ 필수: 완성된 첫 문장 직전 수준의 문장형. 짧되, 읽히는 문장.
  ✓ "오세훈의 이 경고가 과장이라면 선거용이고, 사실이라면 서울 부동산은 또 흔들린다"
  ✓ "서울시장 선거에서 진짜 무서운 건 집값보다 대출 규칙이 다시 흔들리는 순간이다"
  ✓ "호르무즈 봉쇄 리스크가 살아났다 — 한국 에너지 수입 비용이 먼저 흔들린다"
  ✓ "반도체 관세, 협상 카드인가 본게임인가"

■ 길이: 너무 길지 않게. 1~2문장 이내.
■ 3개 훅은 서로 다른 각도여야 한다.
...
5. 마지막 문장: 아래 3가지 유형 중 하나로 끝내라. 그 외 유형은 전부 실패.
   ...
   ✓ "여기서 먼저 봐야 할 건 가격이 아니라 대출 규칙 아닌가"
...
□ 마지막 문장이 조건형/대비형/질문형 중 하나인가? (전망문/훈계문/요약문이면 재작성)
□ final_post가 군더더기 없이 밀도 있는가?
□ final_short가 독립적으로 읽히는가?
□ final_short가 final_post 첫 문장과 다른가?
□ 과장 표현(직격탄/불가피/급등/붕괴)이 없는가?
□ 내부 메모 문구(주의문/관찰 포인트/한줄 결론)가 본문에 그대로 스며들지 않았는가?
□ "추이를 봐야 한다/변수다/주목해야 한다/영향을 미칠 수 있다" 같은 뻔한 마감이 없는가?
